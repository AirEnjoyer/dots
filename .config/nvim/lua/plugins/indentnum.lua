return {
  ...
  config = function()
    ...
    for i = 1, max do
      -- Normal mode
      vim.keymap.set("n", "<Tab>" .. i, function() do_indent(i, false) end,
        { noremap = true, silent = true, desc = "Indent line by " .. i })
      vim.keymap.set("n", "<S-Tab>" .. i, function() do_indent(i, true) end,
        { noremap = true, silent = true, desc = "Unindent line by " .. i })

      -- Visual mode
      vim.keymap.set("v", "<Tab>" .. i, function() do_indent_visual(i, false) end,
        { noremap = true, silent = true, desc = "Indent block by " .. i })
      vim.keymap.set("v", "<S-Tab>" .. i, function() do_indent_visual(i, true) end,
